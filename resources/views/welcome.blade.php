...
<head>
  ...
  <title>Bharathiar University Website</title>
  </head>
...
<body>
  ...
  <section id="header">
    <div class="header container">
      <div class="nav-bar">
        <div class="banner">
            <img src="../assets/banner.jpg" width="500px" height="200px" alt=""/>
            </div>
        <div class="nav-list">
          <div class="hamburger">
            <div class="bar"></div>
  ...
  <section id="home">
    <div class="home container">
      <div>
        ...
        <h1>TO  <span></span></h1>
        <h1>BHARATHIAR UNIVERSITY <span></span></h1>
        <a href="register" type="button" class="cta">Sign Up</a>
      </div>
    </div>
  </section>
  <!-- End home Section  -->
  ...
  <!-- End Footer --> --}}
  <script src="{{ URL::to('assets/app.js') }}"></script>
</body>
