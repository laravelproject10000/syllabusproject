              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-6">
                    <!--dropdown 1-->
                    <div class="dropdown">
                      <select class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false" name="dept">
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="dropdown">
                      ...
                      <select class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false" name="prg">
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="dropdown">
                      ...
                      <select class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false" name="sem">
                ...
                <div class="row">
                  <div class="col-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="maxtime" id="exampleFormControlInput1" placeholder="Enter Time duration">
                        </div>
                    </div>
                   <div class="col-3">
                      <div class="form-group">
                        <label for="exampleFormControlInput1">Credits</label>
                        <input type="text" class="form-control" name="cred" id="exampleFormControlInput1" placeholder="Enter Credits">
                      </div>
                    </div>
                    ...
                    <div class="col-2">
                      ...
                      <div class="popup" onclick="myFunction()"><input type="submit" name="create">
                        ...
                        <div class="tab-content p-0">
                          ...
                          <div class="chart tab-pane active"
                               ...
                               <div class="container-floid" >
                                <center><iframe class="container" id="cardpreview_form" src="" href="view"></iframe></center>
                                </div>
